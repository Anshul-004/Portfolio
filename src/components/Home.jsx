...
const Home = () => {
  return (
    <div
      ...
      id="home"
    >
      <div className="TextBox z-8 text-6xl w-2/3 mb-6 leading-snug">
        <span className="text-purple-500"> Hi There.</span> I'm{" "}
        <span className="underline decoration-purple-400 decoration-wavy">Anshul,</span> a CS Undergrad and a Full-Stack
        Developer.
      </div>
